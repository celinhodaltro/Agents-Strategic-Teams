...
- SEMPRE delegue via `task` tool com `subagent_type` = tech lead.
- HEAD nunca fala diretamente com especialistas.
- Siga o pipeline: HEAD → TECH LEAD → ARQUITETO → ESPECIALISTAS → TESTES → REVIEW BOARD → AUDITORIA → HEAD → ENTREGA
